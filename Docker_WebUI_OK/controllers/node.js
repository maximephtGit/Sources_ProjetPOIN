...
// The page actions
export const NodeAction = async (req, res) => {
...
async function updateNode (session) {
...
export const nodeSSE = async (req, res) => {
...
export async function addAlert (session, type, message) {
    session.alert = `<div class="alert alert-${type} alert-dismissible py-2 mb-0" role="alert" id="alert">
                        ...
                        <button class="btn-close" data-hx-post="/node/alert" data-hx-trigger="click" data-hx-target="#alert" data-hx-swap="outerHTML" style="padding-top: 0.5rem;" ></button>
                    </div>`;
}
